...
| 文档 | 用途 | 时效 |
|---|---|---|
| [面试讲解手册.md](面试讲解手册.md) | **主文档**。话术、10 个创新点、**9 个踩坑**（坑 8 真实录制换血、坑 9 推翻自己的成本门禁设计）、边界划分、数字速记 | 🟢 |
...
| [功能验收方案.md](功能验收方案.md) | 各能力的手工验收步骤与断言。**P11 档验收「量表本身准不准」**。附 **C-5**（指标算出来的三条）、**C-6**（换真实录制暴露的三条）、**C-7**（P5 期间：失败的录制会毁掉既有录制盒），**七条均已修复**，含效果数字 | 🟢 |
