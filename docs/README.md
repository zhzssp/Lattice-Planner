...
| [Agent量化评测体系-工业界方案对标与引入设计.md](design/Agent量化评测体系-工业界方案对标与引入设计.md) | **下一步主线·为什么**：对标 τ-bench / pass^k / RAGAS，及刻意不引入什么 | 🔵 |
| [Agent量化评测-P0至P5实施设计.md](design/Agent量化评测-P0至P5实施设计.md) | **下一步主线·怎么做**：4 个阻塞前提 + 逐期类清单与验收，可直接开工 | 🔵 |
| [功能验收方案.md](功能验收方案.md) | 各能力的手工验收步骤与断言 | 🟡 |
