...
| [Agent量化评测-P0至P5实施设计.md](design/Agent量化评测-P0至P5实施设计.md) | **怎么做**：P0~P4 已实施（含实施中改过的决定）+ §8.1 三条缺陷的修复，P5 待做 | 🟢 |
| [功能验收方案.md](功能验收方案.md) | 各能力的手工验收步骤与断言。**P11 档验收「量表本身准不准」**，附 C-5 三条查出的产品缺陷（**均已修复**，含效果数字） | 🟢 |
