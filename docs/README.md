...
>
> 最近一次整理：2026-09-14（P7 补录落地：C-8 毕业、G1′ 对照、Facts 金标）。
...
| 文档 | 用途 | 时效 |
|---|---|---|
| [面试讲解手册.md](面试讲解手册.md) | **主文档**。话术、10 个创新点、**11 个踩坑**（坑 10 能力题出砸 + C-8 已毕业、**坑 11 `[WORK]` 对照双重无效，G1′ k=1 开过关不过**）、边界划分、数字速记 | 🟢 |
...
| 文档 | 用途 | 时效 |
|---|---|---|
| [Agent评测体系使用指南.md](Agent评测体系使用指南.md) | 怎么跑评测、怎么录制、**怎么判断报告可信**、成本预算门禁与能力集、上下文工程基准 | 🟢 |
...
| [功能验收方案.md](功能验收方案.md) | 各能力的手工验收步骤与断言。附 C-5～C-10（C-10：history-window 曾经是死配置） | 🟢 |
